...
<HTML lang="de">
  ...
  <BODY>
	<div id="contentContact">
		<div class="contact ripple online">
			<img src="../data/portraits/profile1.jpg" class="img_round" style="margin-right: 10px;"></img>
			<div class="contactInfo">
				User
				<div class="contactStatus">Ja finde ich auch.</div>
			</div>
			<span class="contactTime">
				Do, 13:03
			</span>
			<span class="contactNew">
				10
			</span>
		</div>
		<div class="contact ripple">
			<img src="../data/portraits/profile2.jpg" class="img_round" style="margin-right: 10px;"></img>
			<div class="contactInfo">
				User
				<div class="contactStatus">Ok super</div>
			</div>
			<span class="contactTime">
				Mi, 17:03
			</span>
